...
#database_ac("CRM")
#database_tablo_olustur("CRM","Ajanda_Randevu","ID INT AUTO_INCREMENT PRIMARY KEY, Baslik VARCHAR(45), İlgili_Kontaklar VARCHAR(45) ,İlgili_Kullanİcİlar VARCHAR(45),Başlangİç_Saati_ve_Tarihi DATETIME ,Onem_Derecesi VARCHAR(45) ,Durumu VARCHAR(165),Sonuc VARCHAR(165) ")
